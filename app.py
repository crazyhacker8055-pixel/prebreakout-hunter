...
def upstox_nifty500_stream_test(symbols):
    ...
    st.caption(
        "V9.3.4 uses the official NSE Indices NIFTY 500 constituent file first, then Upstox NSE_EQ mapping with instrument-search repair for valid equities. "
    ...
    st.caption("V9.3.4 uses Upstox V3 I1 REST as the authoritative 1-minute engine. WebSocket LTPC is optional; a WebSocket 403 no longer stops the intraday engine.")

def main():
    st.title('🎯 Pre-Breakout Hunter V9.3.4')
