...
def upstox_nifty500_stream_test(symbols):
    ...
    st.caption("Confirmation layer from the live 1-minute candles. It does not replace the strict daily V8 setup; Daily Setup = YES means the stock also passed the saved daily scan.")
    with UPSTOX_WS_LOCK:
...
def main():
    st.title('🎯 Pre-Breakout Hunter V9.4')
