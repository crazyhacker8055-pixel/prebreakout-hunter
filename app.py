...
def main():
    ...
    if scan:
        ...
        try:
            ...
            result_cols=["Stock","Stage","Score","Close","Pivot","To Pivot %","5D Range %","10D Range %","20D Range %","ATR5/ATR20","Vol5/Vol20","Resistance Tests","RS vs Nifty %","To 52W High %","Higher Lows"]
