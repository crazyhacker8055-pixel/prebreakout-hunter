...
def upstox_nifty500_stream_test(symbols):
    ...
    st.caption("Confirmation layer for the focused daily watchlist. V9.5.2 does not seed or poll detailed 1-minute OHLC for all 500 stocks; it seeds strict daily candidates + strongest near-misses, then confirms them with live 1-minute structure.")
    with UPSTOX_WS_LOCK:
...
def main():
    st.title('🎯 Pre-Breakout Hunter V9.5.2')
